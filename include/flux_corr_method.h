#ifndef FLUX_CORR_METHOD_H
#define FLUX_CORR_METHOD_H

#include <stddef.h>

/**
 * Transports quantities using the flux-corrected method, using the Boris &;
 * Book limiter function. This is technique for solving a hyperbolic partial
 * differential equation, that advects quantity 'U'; using 'V
 *
 *
 ...
 */
void flux_corr_method(double *U, double *V, int arrlen, double dt, double dx,
                      double *U_trnsp);

#endif /* FLUX_CORR_METHOD_H */